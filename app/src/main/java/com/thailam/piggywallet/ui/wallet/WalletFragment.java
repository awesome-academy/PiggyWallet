...
public class WalletFragment extends Fragment implements WalletContract.View {
     ...
     */
    public static WalletFragment newInstance(List<Wallet> wallets) {
        WalletFragment fragment = new WalletFragment();
        Bundle args = new Bundle();
        ArrayList<Wallet> list = new ArrayList<>(wallets);
        args.putParcelableArrayList(Constants.ARGUMENT_WALLETS, list);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mWallets = getArguments().getParcelableArrayList(Constants.ARGUMENT_WALLETS);
        }
    }
